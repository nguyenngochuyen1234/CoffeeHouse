                ...
                <div className='mt-6'>
                    <Row>
                        <Col xs={24} md={16} sm={24} className='grid grid-cols-2 gap-3'>
                            ...
                            <div className='absolute w-[1px] bg-[orange] h-[712px] top-0 right-3'></div>
                        </Col>
                        <Col xs={24} md={8} sm={24}>
                            <p className='text-[30px] font-[600]'>E-BOOK</p>
                            <ul className='grid grid-cols-2 gap-3'>
                                <li><a href="" ><img className='img-ebook' src="https://file.hstatic.net/1000075078/article/thumbnail_photobook_cb264086a49440b48a95d4c148bbea0e_large.jpg" alt="img" /></a></li>
                                <li><a href=""><img src="https://file.hstatic.net/1000075078/article/crop32_large.jpg" alt="img" /></a></li>
                                <li><a href=""><img src="https://file.hstatic.net/1000075078/article/crop22_large.jpg" alt="img" /></a></li>
                                <li><a href=""><img src="https://file.hstatic.net/1000075078/article/crop12_large.jpg" alt="img" /></a></li>
                            </ul>
                        </Col>
                    </Row>
                </div>
